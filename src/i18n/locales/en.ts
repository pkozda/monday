export default {
  ...
  nearbyDoctors: {
    ...
    subtitle:
      'Search by specialty and distance from your location. Uses Google Places when configured, otherwise OpenStreetMap.',
    ...
    locationUnknown: 'Near you',
    search: 'Search',
    searching: 'Searching…',
    distanceKm: '{km} km away',
    noRating: 'No rating',
    ratingAria: 'Rated {rating} out of 5 from {count} reviews',
    reviewCount: '{count} reviews',
    phone: 'Phone',
    email: 'Email',
    notAvailable: 'Not listed',
    openInMaps: 'Open in maps',
    mapLabel: 'Map of doctor search results',
    resultsCount: '{count} places',
    resultsListLabel: 'Search results',
    sourceGoogle: 'Google',
    sourceOsm: 'OSM',
    osmFallback: 'No Google results for this area; showing OpenStreetMap listings.',
    noResults: 'No doctors found in this radius. Try a larger distance or another specialty.',
    searchQuery: {
      default: 'doctor',
    ...
    errors: {
      geolocationUnsupported: 'Location is not supported in this browser.',
      geolocationDenied: 'Could not get your location. Allow location access and try again.',
      needLocation: 'Set your location before searching.',
