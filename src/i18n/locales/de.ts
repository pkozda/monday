export default {
  ...
  nearbyDoctors: {
    title: 'Ärzte in der Nähe finden',
    subtitle:
      'Suche nach Fachrichtung und Entfernung von Ihrem Standort. Mit Google Places, falls konfiguriert, sonst OpenStreetMap.',
    providerGoogle: 'Google Places',
    providerOsm: 'OpenStreetMap',
    radiusLabel: 'Umkreis',
    radiusKm: '{km} km',
    specialtyLabel: 'Fachrichtung',
    locationLabel: 'Ihr Standort',
    useMyLocation: 'Mein Standort',
    locating: 'Standort wird ermittelt…',
    resolvingAddress: 'Adresse wird ermittelt…',
    locationUnknown: 'In Ihrer Nähe',
    search: 'Suchen',
    searching: 'Suche läuft…',
    distanceKm: '{km} km entfernt',
    noRating: 'Keine Bewertung',
    ratingAria: 'Bewertung {rating} von 5 ({count} Bewertungen)',
    reviewCount: '{count} Bewertungen',
    phone: 'Telefon',
    email: 'E-Mail',
    notAvailable: 'Nicht angegeben',
    openInMaps: 'In Karte öffnen',
    mapLabel: 'Karte der Suchergebnisse',
    resultsCount: '{count} Treffer',
    resultsListLabel: 'Suchergebnisse',
    sourceGoogle: 'Google',
    sourceOsm: 'OSM',
    osmFallback:
      'Keine Google-Ergebnisse in diesem Gebiet; OpenStreetMap-Einträge werden angezeigt.',
    noResults:
      'Keine Ärzte in diesem Umkreis. Größeren Radius oder andere Fachrichtung wählen.',
    searchQuery: {
      default: 'Arzt',
      primary_care: 'Hausarzt Allgemeinmedizin',
      orthopedics: 'Orthopäde',
      dermatology: 'Hautarzt Dermatologie',
      cardiology: 'Kardiologe',
      gastroenterology: 'Gastroenterologe',
      neurology: 'Neurologe',
      endocrinology: 'Endokrinologe',
      pulmonology: 'Pneumologe Lunge',
      urology: 'Urologe',
      gynecology: 'Gynäkologe Frauenarzt',
    ...
    errors: {
      geolocationUnsupported: 'Standort wird in diesem Browser nicht unterstützt.',
      geolocationDenied:
        'Standort konnte nicht ermittelt werden. Standortfreigabe erlauben und erneut versuchen.',
      needLocation: 'Bitte zuerst den Standort festlegen.',
