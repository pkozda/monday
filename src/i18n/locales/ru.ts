export default {
  ...
  nearbyDoctors: {
    title: 'Найти врачей рядом',
    subtitle:
      'Поиск по специальности и расстоянию от вас. Google Places при настройке, иначе OpenStreetMap.',
    ...
    useMyLocation: 'Моё место',
    locating: 'Определение местоположения…',
    resolvingAddress: 'Определение адреса…',
    locationUnknown: 'Рядом с вами',
    search: 'Искать',
    searching: 'Поиск…',
    distanceKm: '{km} км',
    noRating: 'Нет оценки',
    ratingAria: 'Оценка {rating} из 5 ({count} отзывов)',
    reviewCount: '{count} отзывов',
    phone: 'Телефон',
    email: 'Эл. почта',
    notAvailable: 'Не указано',
    openInMaps: 'Открыть на карте',
    mapLabel: 'Карта результатов поиска',
    resultsCount: '{count} мест',
    resultsListLabel: 'Результаты поиска',
    sourceGoogle: 'Google',
    sourceOsm: 'OSM',
    osmFallback:
      'Google не нашёл результатов в этой области; показаны данные OpenStreetMap.',
    noResults:
      'Врачи в этом радиусе не найдены. Увеличьте радиус или выберите другую специальность.',
    searchQuery: {
      default: 'врач',
      primary_care: 'терапевт семейный врач',
      orthopedics: 'ортопед',
    ...
    errors: {
      ...
      geolocationDenied:
        'Не удалось получить местоположение. Разрешите доступ к геолокации и повторите.',
      needLocation: 'Сначала укажите местоположение.',
