export default {
  ...
  diagnosis: {
    ...
    crossBodyNote:
      'Учитываются записи из других областей тела при связи с состоянием.',
    uncertainNote:
      'Нет явного лидера — сравните варианты с врачом.',
    historyFit: 'Совпадение с журналом {score}/100',
    whySuggested: 'Почему предложено',
    ...
    rationale: {
      primaryScope: '{count} {entries} в {area}',
      crossScope: '{count} межзональных {entries}',
      scopeAnd: 'и',
      fullHistory: 'вся ваша история болезни',
      criteriaMet: ' {met} из {total} поддерживающих критериев в журнале.',
      exclusions: ' {count} исключающих {factors}.',
      factor: 'фактор',
      factors: 'факторов',
      body: 'Точность {score}/100 по {scope}, симптомам и критериям.{criteriaNote} Не подтверждённый диагноз — обсудите критерии с врачом.',
    },
    variantFooter: {
